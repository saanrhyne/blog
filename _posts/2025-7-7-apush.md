...
This article is meant to be a fairly comprehensive guide that, if followed properly, will substantially increase your preparedness for the Advanced Placement United States History examination. However, I cannot guarentee any single result on your classwork and AP exam. Feel free to [contact me](https://saanrhyne.github.io/#:~:text=You%20can%20contact%20me%20via) if you have any questions, feedback, or want some more help with APUSH.
...
## Resources I Used
This is the long list of every single resource I used in preparation for APUSH, and my review of them. This list is in no particular order.
...
### AMSCO Advance Placement United History 4th Edition (Textbook)
**My rating:** :star::star::star::star::star:
